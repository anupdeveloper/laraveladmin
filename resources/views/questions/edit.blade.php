    ...
    <div class="col-md-12">
        <div class="card">
          <div class="card-header alert d-flex justify-content-between align-items-center">
            <h3>{{ __('adminlte::adminlte.subject_details') }}</h3>
          ...
          <div class="card-body">
            ...
            @endif
            <form id="editJobseekerForm" method="post", action="{{ route('update_subject') }}">
              @csrf
              <div class="card-body form">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      <label for="desc">{{ __('adminlte::adminlte.desc') }}<span class="text-danger"> *</span></label>
                      <input type="text" name="desc" class="form-control" id="desc" value="{{ $list[0]->desc }}" maxlength="100">
                      <!-- <i class="fa fa-edit editable_field text-success"></i>
                      <i class="fa fa-times non_editable_field text-danger"></i> -->
                      @if($errors->has('desc'))
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="duration" class="form-control" id="duration" value="{{ $list[0]->duration }}" maxlength="100">
                      <!-- <i class="fa fa-edit editable_field text-success"></i>
                      <i class="fa fa-times non_editable_field text-danger"></i> -->
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      <label for="school_id">{{ __('adminlte::adminlte.school') }}</label>
                      <select name="school_id" class="form-control">
                        <option value="">Select One</option>
                        @foreach ($school_list as $row)
                          @php
                            $sel = '';
                            if($row->id == $list[0]->school_id)
                              $sel = 'selected';
                          @endphp
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      <label for="course_id">{{ __('adminlte::adminlte.course_list') }}</label>
                      <select name="course_id" class="form-control">
                        <option value="">Select One</option>
                        @foreach ($course_list as $row)
                          @php
                            $sel = '';
                            if($row->id == $list[0]->course_id)
                              $sel = 'selected';
                          @endphp
                          <option {{ $sel }} value="{{ $row->id }}">{{ $row->name }}</option>
                        @endforeach
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group radio">
                      <div class="job_alerts">
                        ...
                        <label class="switch">
                            <input name="status" type="checkbox" {{($list[0]->status)?'checked':''}}>
...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
  <script>
    ...
    $('body').on('click','.submit-job-alert',function(e){
        ...
        var url = '{{route('store.job.alert',$list[0]->id)}}';
        $.ajax({
            type: "POST",
            url: url,
            data: data,
