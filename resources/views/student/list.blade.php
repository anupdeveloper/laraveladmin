    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header alert d-flex justify-content-between align-items-center">
          ...
          @can('add_jobseeker')<a class="btn btn-sm btn-success" href="{{ route('add_student') }}">{{ __('adminlte::adminlte.add_new') }}</a>@endcan
        </div>
        <div class="card-body">
          @if (session('status'))
...
@section('js')
  ...
  <script>
    ...
    $('.delete-button').click(function(e) {
      ...
      swal({
        title: "Are you sure?",
        text: "Are you sure you want to move this Student to the Recycle Bin?",
        type: "warning",
