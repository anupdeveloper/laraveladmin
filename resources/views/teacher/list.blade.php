    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header alert d-flex justify-content-between align-items-center">
          ...
          @can('add_jobseeker')<a class="btn btn-sm btn-success" href="{{ route('add_teacher') }}">{{ __('adminlte::adminlte.add_new') }}</a>@endcan
        </div>
        <div class="card-body">
          @if (session('status'))
          ...
          <table style="width:100%" id="jobseekers-list" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $list[$i]->is_email_verified ? 'Verified' : 'Not Verified' }}</td>
...
@section('js')
  ...
  <script>
    ...
    $('.delete-button').click(function(e) {
      ...
      swal({
        title: "Are you sure?",
        text: "Are you sure you want to move this Teacher to the Recycle Bin?",
        type: "warning",
