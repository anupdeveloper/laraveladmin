    ...
    <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            @endif
            <form id="editJobseekerForm" method="post", action="{{ route('update_course') }}">
              @csrf
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="desc" class="form-control" id="desc" readonly value="{{ $list[0]->desc }}" maxlength="100">
                      <!-- <i class="fa fa-edit editable_field text-success"></i>
                      <i class="fa fa-times non_editable_field text-danger"></i> -->
                      @if($errors->has('desc'))
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="price" class="form-control" id="price" value="{{ $list[0]->price }}" maxlength="100">
                      <!-- <i class="fa fa-edit editable_field text-success"></i>
                      <i class="fa fa-times non_editable_field text-danger"></i> -->
                      @if($errors->has('price'))
