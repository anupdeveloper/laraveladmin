            ...
            <form id="addJobseekerForm" method="post", action="{{ route('save_course') }}">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label for="duration">Course Start Date<span class="text-danger"> *</span></label>
                      <input type="date" name="course_start_date" class="form-control" id="duration" maxlength="100">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label for="price">Subject<span class="text-danger"> *</span></label>
                      <input name="subject" class="form-control" id="price" value="" maxlength="13">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label for="duration">Course Code<span class="text-danger"> *</span></label>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label for="created_by">Select Teacher<span class="text-danger"> *</span></label>
                      ...
                      @if($errors->has('created_by'))
                        <div class="error">{{ $errors->last('created_by') }}</div>
                      @endif
                    </div>
                  </div>
