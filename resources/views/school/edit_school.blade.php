    ...
    <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            @endif
            <form id="editJobseekerForm" method="post", action="{{ route('update_school') }}">
              @csrf
              <div class="card-body form">
                <input type="hidden" name="id" class="form-control" id="id" value="{{ $school_list[0]->id }}">
                <div class="row">
                  <!-- <div class="col-12">
                    <div class="form-group">
                      <label for="name">Name<span class="text-danger"> *</span></label>
                      <input type="name" name="name" class="form-control" id="name" value="{{ $school_list[0]->name }}" maxlength="100">
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control" id="name" value="{{ $school_list[0]->name }}" maxlength="100">
                      <!-- <i class="fa fa-edit editable_field text-success"></i>
                      <i class="fa fa-times non_editable_field text-danger"></i> -->
                      @if($errors->has('name'))
                        <div class="error">{{ $errors->first('name') }}</div>
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="email" class="form-control" id="email" readonly value="{{ $school_list[0]->email }}" maxlength="100">
                      <!-- <i class="fa fa-edit editable_field text-success"></i>
                      <i class="fa fa-times non_editable_field text-danger"></i> -->
                      @if($errors->has('email'))
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      <label for="website">{{ __('adminlte::adminlte.website') }}<span class="text-danger"> *</span></label>
                      <input type="text" name="website" class="form-control" id="email" value="{{ $school_list[0]->website }}" maxlength="100">
                      <!-- <i class="fa fa-edit editable_field text-success"></i>
                      <i class="fa fa-times non_editable_field text-danger"></i> -->
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="address" class="form-control" id="address" value="{{ $school_list[0]->address }}" maxlength="100">
                      <!-- <i class="fa fa-edit editable_field text-success"></i>
                      <i class="fa fa-times non_editable_field text-danger"></i> -->
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      <label for="phone">{{ __('adminlte::adminlte.contact_number') }}</label>
                      <input id="jquery-intl-phone" type="tel" name="phone" class="form-control" id="phone" value="{{ $school_list[0]->phone ? $school_list[0]->phone : '+44' }}" maxlength="13">
                      <!-- <i class="fa fa-edit editable_field text-success"></i>
                      <i class="fa fa-times non_editable_field text-danger"></i> -->
                      @if($errors->has('phone'))
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group radio">
                      <div class="job_alerts">
                        ...
                        <label class="switch">
                            <input name="email_verified" type="checkbox" {{($school_list[0]->status)?'checked':''}}>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="modal-body text-left" id="job_alert_form">
                ...
                @php
                    $job_alert = \App\Models\JobAlert::where('user_id',$school_list[0]->id)->first();
...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
  <script>
    ...
    $('body').on('click','.submit-job-alert',function(e){
        ...
        var url = '{{route('store.job.alert',$school_list[0]->id)}}';
        $.ajax({
            type: "POST",
            url: url,
            data: data,
