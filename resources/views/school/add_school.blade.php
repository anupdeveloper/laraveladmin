    ...
    <div class="col-md-12">
        <div class="card">
          <div class="card-header alert d-flex justify-content-between align-items-center">
            <h3>{{ __('adminlte::adminlte.add_new_school') }}</h3>
            ...
            <form id="addJobseekerForm" method="post", action="save">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label for="website">{{ __('adminlte::adminlte.website') }}</label>
                      <input type="text" name="website" class="form-control" id="website" maxlength="100">
                      @if($errors->has('website'))
                        <div class="error">{{ $errors->last('website') }}</div>
                      @endif
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input id="jquery-intl-phone" type="tel" name="phone" class="form-control" id="phone" value="+44" maxlength="13">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="address" class="form-control" id="address" maxlength="100">
